...
def main():
    parser = argparse.ArgumentParser(description='Import properties from text file.')
    ...
    print(f"Parsing text file {args.input_file}...", flush=True)
    properties = parse_text_file(args.input_file)
